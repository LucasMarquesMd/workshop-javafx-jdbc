...
public class SellerFormController implements Initializable{
	...
	private Seller getFormData() {
		...
		//Pesq
		//atStarOfDay() -> converte a data escolhida no formulario (comp usuario) para uma data Instant (independente de localidade)
	...
	public void loadAssociatedObjects() {
		...
		//Associar o obsList ao combobox
