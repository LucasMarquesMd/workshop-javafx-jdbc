...
public class DepartmentListController implements Initializable, DataChangeListener{
	...
	@FXML
	private TableColumn<Department, Department> tableCollumnEDIT;
	...
	private void createDialogForm(Department obj, String absoluteName, Stage parentStage) {
		try {
			...
			dialogStage.initModality(Modality.WINDOW_MODAL);//O usuario nao pode clicar em nada fora da janela ate encerra-la
			//Executar a janela
	...
	private void initEditButtons() {
		...
		tableCollumnEDIT.setCellFactory(param -> new TableCell<Department, Department>(){
